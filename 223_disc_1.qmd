...
#if dam ht m is = -99, set it to NA
gdw_sf <- gdw_sf |> 
...
tm_shape(gdw_sf) +
  ...
  tm_dots(size = "dam_hgt_m", col = "dam_type", palette = "Set1", 
          popup.vars = c("Reservoir Name" = "res_name", 
                         "Dam Name" = "dam_name", 
                         "Country" = "country", 
                         "Height of Dam/Barrier (m)" = "dam_hgt_m"),
          title.size = "Height of Dam/Barrier (m)",
          title.col = "Dam Type") +
