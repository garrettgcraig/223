...
values(SB_classification_kmeans) <- NA # set all values to NA

#take the XY coord from landsat_df and convert to cell numbers for the raster
...
```{r}
tmap_arrange(dt_plot, kmeans_plot, nrow = 2)
```
